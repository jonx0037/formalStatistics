...
export const exponentialFamilyMembers: ExponentialFamilyMember[] = [
  ...
  },
  {
    ...
    AprimeEta: "(\\psi(\\alpha) - \\log\\beta,\\, \\alpha/\\beta)",
...
export const logPartitionFunctions: Record<string, {
  ...
  Geometric: {
    A: (eta) => eta - Math.log(1 - Math.exp(eta)),
    Aprime: (eta) => 1 / (1 - Math.exp(eta)),
...
export const derivationSteps: Record<string, DerivationStep[]> = {
  ...
  Geometric: [
    ...
    { description: "Identify the sufficient statistic", latex: "T(k) = k", highlight: "T" },
    { description: "Identify the log-partition function", latex: "A(\\eta) = \\eta - \\log(1-e^\\eta)", highlight: "A" },
    { description: "Write in canonical form", latex: "p(k \\mid \\eta) = \\exp\\!\\bigl(\\eta k - (\\eta - \\log(1-e^\\eta))\\bigr)" },
  ],
  Binomial: [
  ...
  NegBin: [
    ...
    { description: "Identify the natural parameter", latex: "\\eta = \\log(1-p)", highlight: "eta" },
    { description: "Identify the sufficient statistic", latex: "T(k) = k", highlight: "T" },
    { description: "Identify the log-partition function", latex: "A(\\eta) = r\\eta - r\\log(1-e^\\eta)", highlight: "A" },
    { description: "Write in canonical form", latex: "p(k \\mid \\eta) = \\binom{k-1}{r-1} \\exp\\!\\bigl(\\eta k - r\\eta + r\\log(1-e^\\eta)\\bigr)" },
  ],
  Gamma: [
