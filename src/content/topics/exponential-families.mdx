...
formalmlConnections:
  ...
  - topic: "mixed-effects"
    site: "formalml"
    relationship: "Every GLM requires an exponential family response distribution and the canonical link is (A')⁻¹. The Mixed-Effects Models topic develops logistic, Poisson, and Gamma regression as sections within its unified random-effects framework — fixed-effects GLMs fall out as the no-random-effects special case."
