...
Using integration by parts (with $u = x$, $dv = \lambda e^{-\lambda x} dx$) from <ExternalLink href="https://formalcalculus.com/topics/improper-integrals" site="formalcalculus" topic="Improper Integrals & Special Functions" />:
