...
- [Discrete Distributions](/topics/discrete-distributions) and **Continuous Distributions** (coming soon) apply the expectation and variance formulas to every named distribution — Binomial, Poisson, Normal, Exponential, Gamma, Beta.
