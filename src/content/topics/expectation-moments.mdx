...
This uniqueness theorem is what makes MGFs a powerful proof tool: if you can show two random variables have the same MGF, you've shown they have the same distribution. We'll use this in the proof of the Central Limit Theorem — see [Modes of Convergence](/topics/modes-of-convergence) for the framework and [Central Limit Theorem](/topics/central-limit-theorem) (coming soon) for the full proof.
...
| MGF uniqueness | Proof of Central Limit Theorem ([Modes of Convergence](/topics/modes-of-convergence) + [CLT](/topics/central-limit-theorem), coming soon) |
