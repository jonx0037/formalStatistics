...
{/* The five Topic-17 interactive components are wired in Checkpoint 3:
    NullAlternativeSimulator, PowerCurveExplorer, PValueDemonstrator,
    TTestBasuFoundation, WaldScoreLRTComparison. */}
...
{/* <NullAlternativeSimulator client:visible /> — added in Checkpoint 3 */}
...
{/* <PowerCurveExplorer client:visible /> — added in Checkpoint 3 */}
...
{/* <PValueDemonstrator client:visible /> — added in Checkpoint 3 */}
...
{/* <TTestBasuFoundation client:visible /> — the featured Track-5 component, added in Checkpoint 3 */}
...
{/* <WaldScoreLRTComparison client:visible /> — added in Checkpoint 3 */}
