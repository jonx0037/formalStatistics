...
references:
  ...
  - type: "paper"
    ...
    note: "The ASA's consensus statement on p-value misuse. Cited in §17.5 Remark 6, along with Ioannidis (2005) and Gelman–Loken (2013), as pointers to the replication-crisis literature. Full treatment of multiple testing is Topic 20."
  - type: "paper"
  ...
  - type: "paper"
    ...
    note: "Gelman–Loken's argument that researcher-degrees-of-freedom inflate Type I error even in good-faith analyses. Cited in §17.5 Remark 6 as the conceptual preview of Topic 20."
---
...
- **Multiple Testing (coming soon, Topic 20)** — family-wise error (Bonferroni, Holm, Šidák), false discovery rate (Benjamini-Hochberg, adaptive FDR), the replication crisis in quantitative terms.
