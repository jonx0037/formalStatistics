...
formalcalculusPrereqs:
  ...
  - topic: "lp-spaces"
    site: "formalcalculus"
    relationship: "Chi-squared and goodness-of-fit test statistics are $L^2$ norms of standardized residuals. Cramér–von Mises and Anderson–Darling statistics measure $L^2$ distance between empirical and hypothesized CDFs — the formalcalculus $L^p$-spaces machinery is the rigorous foundation."
  - topic: "radon-nikodym"
    site: "formalcalculus"
    relationship: "The absolute-continuity assumption $P_1 \\ll P_0$ in hypothesis testing means the null assigns positive probability to every event of positive alternative probability — precisely the hypothesis of the Radon–Nikodym theorem. Without it, likelihood ratios are undefined on positive-probability events."
formalmlConnections:
  - topic: "causal-inference-methods"
    site: "formalml"
    relationship: "Randomized experiments use t-tests and z-tests for average treatment effects; falsification and placebo tests are hypothesis tests for identification assumptions. §9.4's weak-IV-robust tests (Anderson–Rubin, conditional likelihood ratio) and §12's Rosenbaum sensitivity bounds are inverted from hypothesis tests of the null treatment effect; §11.4 CATE heterogeneity tests are tests of constant treatment effect."
  - topic: "high-dimensional-regression"
    site: "formalml"
    relationship: "The inferential apparatus — Type I/II errors, p-values, Wald and likelihood-ratio tests under normal asymptotics — carries directly to high-dimensional-regression's §10 debiased lasso, which produces a $\\sqrt n$-consistent normal estimator. The PoSI undercoverage demonstration and debiased-lasso fix appeal directly to this topic's testing framework."
  - topic: "rank-tests"
    site: "formalml"
    relationship: "Provides the $H_0/H_1$ framework, type-I error, $p$-value definition, and level-vs-size distinction that every section of rank-tests deploys without redefinition. The permutation-test exactness theorem in §2 is a finite-sample analog of the level-$\\alpha$ framework developed here."
  - topic: "vc-dimension"
    site: "formalml"
    relationship: "PAC learning's $(\\varepsilon, \\delta)$-formulation in §6.1 of vc-dimension is structurally parallel to hypothesis testing's $(\\alpha, \\beta)$-power calculation; familiarity with the testing framework's tradeoffs provides the natural intuition for the sample-complexity bounds in §§7.1–7.2."
connections:
