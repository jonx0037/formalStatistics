...
connections:
  ...
  - topic: "continuous-distributions"
    relationship: "Topic 6 introduces Chi-squared, Student's t, and F as derived distributions with the (coming soon) promise of full use in hypothesis testing. §17.6, §17.7, §17.8 together fulfill that promise: z uses Normal, t uses Student's t_{n-1}, chi-squared uses $\\chi^2_{n-1}$, F (one-sample variance ratio) is cited in §17.8 Example 6 with full two-sample F-test deferred to linear-regression."
references:
  - type: "book"
