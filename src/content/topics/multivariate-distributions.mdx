...
connections:
  ...
  - topic: "bayesian-computation"
    relationship: "Multivariate posteriors are the starting point for MCMC and variational methods. The conditional MVN powers Gibbs sampling. The Wishart distribution (Remark in §7) is the conjugate prior for the MVN covariance matrix."
references:
  - type: "book"
