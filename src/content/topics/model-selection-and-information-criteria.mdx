...
formalcalculusPrereqs:
  ...
  - topic: "hessian"
    site: "formalcalculus"
    relationship: "TIC (Takeuchi IC) replaces the AIC penalty $2d$ with $\\mathrm{tr}(J \\cdot I^{-1})$ where $J, I$ are observed/expected Fisher information — both Hessians. BIC's asymptotic derivation uses the log-determinant of the Hessian at the MLE, and §24.5 Stone's proof leans on Hessian curvature."
formalmlConnections:
  - topic: "stacking-and-predictive-ensembles"
    site: "formalml"
    relationship: "Develops AIC, BIC, WAIC, and LOO as model-selection criteria; PSIS-LOO is the modern computational realization of LOO that stacking-and-predictive-ensembles uses, and the broader information-criteria context for the marginal-likelihood vs. predictive-density distinction lives in this topic."
  - topic: "variational-bayes-for-model-selection"
    site: "formalml"
    relationship: "§3 of variational-bayes-for-model-selection's Laplace-to-BIC asymptotic bridge specializes the classical-IC framework this topic develops; §13's alternatives section places VBMS alongside AIC/BIC/WAIC/LOO, all of which trace through here. The BIC penalty $-(d/2)\\log n$ is the VBMS reference point."
...
references:
  ...
  - type: "book"
    ...
    edition: "1st"
    publisher: "Cambridge University Press"
    note: "Inherited. Ch. 7 RE conditions; Ch. 11 post-selection. §24.10 Rem 24 + Rem 29."
---
...
<RemarkBlock number={7} title="Bayes factors, Akaike weights, and BMA (forward to §24.10 Rem 23)">
{/* TODO Task 7: 4–5 sentences. The Q6 amplification: BIC ≈ -2 log marginal likelihood,
    ...
    full forward-pointer at §24.10 Rem 23 + Track 7. */}
...
<RemarkBlock number={23} title="Bayesian model averaging — full pointer (forward from §24.4 Rem 7)">
...
<RemarkBlock number={24} title="Post-selection inference — full pointer">
...
<RemarkBlock number={25} title="Stepwise / forward-backward selection — dismissed with citations">
...
<RemarkBlock number={26} title="DIC / WAIC / PSIS-LOO — Bayesian information criteria (single remark per Q5)">
...
<RemarkBlock number={27} title="MDL — minimum description length (Rissanen 1978)">
...
<RemarkBlock number={28} title="Time-series + graphical-model selection (one-sentences each)">
...
<RemarkBlock number={29} title="High-dimensional IC: Extended BIC, stability selection, knockoffs">
...
<RemarkBlock number={30} title="Structural risk minimization (VC theory, Rademacher complexity)">
...
<RemarkBlock number={31} title="Track 7 on-ramp: BIC → marginal likelihood → BMA → MCMC">
...
- **[Posterior computation via MCMC](/topics/bayesian-computation-and-mcmc)**: [Metropolis–Hastings](/topics/bayesian-computation-and-mcmc#section-26-2) ([Topic 26 §26.2](/topics/bayesian-computation-and-mcmc#section-26-2)), [Hamiltonian Monte Carlo](/topics/bayesian-computation-and-mcmc#section-26-4) (§26.4), [NUTS](/topics/bayesian-computation-and-mcmc#section-26-5) (§26.5; Hoffman & Gelman 2014).
