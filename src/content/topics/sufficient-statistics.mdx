...
formalcalculusPrereqs:
  ...
  - topic: "riemann-integral"
    site: "formalcalculus"
    relationship: "The factorization theorem and Rao–Blackwell proofs use joint-density integration and the interchange of integration with conditional expectation (Fubini). The PKD proof integrates a separable functional equation in both arguments; the Riemann-integral framework is the underlying machinery."
formalmlConnections:
