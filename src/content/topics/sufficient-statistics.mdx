...
- **Confidence Intervals** (coming soon) — pivotal quantities are constructed from ancillary statistics (Basu's theorem gives the required independence); Wilks-type intervals use asymptotic sufficiency of the MLE.
